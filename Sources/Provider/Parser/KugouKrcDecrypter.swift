...
class KugouKrcDecrypter {
    
    private static let decodeKey: [UInt8] = [64, 71, 97, 119, 94, 50, 116, 71, 81, 54, 49, 45, 206, 210, 110, 105]
    private static let flagKey = "krc1".data(using: .ascii)!
